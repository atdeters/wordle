...
var gl, clipboard = null,
    wasm_memory, animation_frame_timeout, FS, GL, Module, wasm_exports, emscripten_shaders_hack, importObject, plugins = [],
    high_dpi = !1,
...
function() {
    ...
    function a(e) {
        t = new WebSocket(consume_js_object(e)), t.binaryType = "arraybuffer", t.onopen = function() {
            o = 1
        }, t.onmessage = function(e) {
            if (typeof e.data == "string") n.push({
                text: 1,
                data: e.data
            });
            else {
    ...
    function h(t, n, o, i) {
        var a, r, c, d, u, l = s;
        s += 1, t == 0 && (r = "POST"), t == 1 && (r = "PUT"), t == 2 && (r = "GET"), t == 3 && (r = "DELETE"), d = consume_js_object(n), u = consume_js_object(o), c = consume_js_object(i), a = new XMLHttpRequest, a.open(r, d, !0), a.responseType = "arraybuffer";
